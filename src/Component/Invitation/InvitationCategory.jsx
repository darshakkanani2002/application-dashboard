...
export default function InvitationCategory({ vCatId: _id }) {
            ...
            <div className="px-2">
                ...
                <div className='container padding-top-90'>
                    <form onSubmit={handleSubmit}>
                        <div className='row border p-3 daily-category-form category-form'>
                            ...
                            <div className='col-lg-12 mb-3'>
                                ...
                                <input
                                    type="file"
                                    name="file"
                                    className='form-control border w-100 rounded'
                            ...
                            <div className='col-lg-12 mb-3'>
                                <button type='submit' className='btn btn-success text-center px-2 py-2 d-flex m-auto' data-bs-dismiss="modal">
